...
public class Device_list_Scenario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_device_list__scenario);
    ...
    private AdapterView.OnItemClickListener clickOnAddress = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
            ...
            Intent intent = new Intent(Device_list_Scenario.this, Simulation.class);
            intent.putExtra(EXTRA_ADDRESS, address);
            Device_list_Scenario.this.finish();
